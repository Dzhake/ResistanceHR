...
namespace ResistanceHR.Traits.Item_Restrictions
{
    ...
    {
        public override List<string> ProhibitedItemCategories => new List<string>() { CItemCategory.Vegetarian };
        public override List<string> ProhibitedItemTypes => new List<string>() { };
        protected override List<string> Dialogue => new List<string>() { CDialogue.CantUseVegetarian };
