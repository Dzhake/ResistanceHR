...
{
	internal abstract class T_Roamers : T_Spawns
	{
		private static readonly ManualLogSource logger = RHRLogger.GetLogger();
		private static GameController GC => GameController.gameController;

		internal T_Roamers() : base() { }

		internal abstract string AgentRelationship { get; }
		internal abstract bool AgentsAlwaysRun { get; }
		internal abstract int GroupSize { get; }
		...
		internal static List<Agent> SpawnRoamerSquad(Agent playerAgent, int numberToSpawn, string agentType, string relationship, int splitIntoGroupSize)
		{
