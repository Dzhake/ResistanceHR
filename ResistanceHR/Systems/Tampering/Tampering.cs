...
namespace ResistanceHR.Tampering
{
	...
	internal static class P_ObjectReal_TamperObject
	{
		...
		public static void FinishedOperating(ObjectReal objectReal)
		{
			...
			{
				case Tampering.Stove_GrillingFud:
					Stove_GrillFud.FinishedOperating((Stove)objectReal);
					break;
			}
