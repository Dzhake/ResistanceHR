...
{
	public abstract class T_VisionRange : T_RHR
	{
		//  WARNING: This breaks level editor zoom. Don't reactivate until fixed!
		...
		public static float ScaleToZoom(float vanilla, Agent agent) =>
			vanilla / GetZoomLevel(agent);
		public static Vector3 ScaleToZoom(Vector3 vanilla, Agent agent)
		{
	...
	public static class P_Agent_VisionRange
	{
		private static readonly ManualLogSource logger = BLLogger.GetLogger();
		private static GameController GC => GameController.gameController;
		...
		public static bool test1(Agent __instance)
		{
	...
	public static class P_ObjectReal_VisionRange
	{
		private static readonly ManualLogSource logger = BLLogger.GetLogger();
		private static GameController GC => GameController.gameController;
